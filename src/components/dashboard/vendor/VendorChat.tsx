                        ...
                        <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                            ...
                            >
                                <Dialog.Panel className="pointer-events-auto w-screen max-w-6xl">
                                    <div className="flex h-full flex-row bg-[#F3F0EB] shadow-2xl overflow-hidden relative">

                                        <button
                                            onClick={onClose}
                                            className="absolute top-6 right-6 z-50 p-3 bg-white hover:bg-gray-50 text-[#1D2939] rounded-2xl shadow-sm border border-transparent hover:border-gray-200 transition-all"
                                        >
                                            <XMarkIcon className="w-6 h-6" />
                                        </button>

                                        {/* Main Chat Area */}
                                        <div className="flex-1 flex flex-col h-full bg-white border-r border-gray-100 shadow-2xl relative z-10">
                                            {/* Header */}
                                            <div className="px-10 py-6 border-b border-gray-100 bg-white/80 backdrop-blur-md sticky top-0 z-10">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-5">
                                                        <div className="relative group">
                                                            ...
                                                            <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=120&auto=format&fit=crop" alt="Client" className="w-12 h-12 rounded-[20px] object-cover relative ring-2 ring-white" />
                                                            <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-green-500 border-4 border-white rounded-full"></div>
                                                        </div>
                                                        <div>
                                                            <h3 className="text-base font-black text-[#1D2939] tracking-tight">Oluwatobiloba Babatunde</h3>
                                                    ...
                                                    <div className="flex items-center gap-3 mr-16">
                                                        <button className="p-3 text-gray-400 hover:text-[#D0771E] hover:bg-orange-50 rounded-2xl transition-all">
                                            ...
                                            {/* Messages */}
                                            <div className="flex-1 overflow-y-auto px-10 py-8 space-y-10 bg-[#F9FAFB]/50 scrollbar-hide">
                                                <div className="flex items-center gap-6 py-4">
                                                    <div className="h-px flex-1 bg-gray-100"></div>
                                                    <span className="text-[9px] font-black text-gray-300 uppercase tracking-[0.25em]">Today, March 24</span>
                                                    <div className="h-px flex-1 bg-gray-100"></div>
                                                </div>
                                                    ...
                                                    <div key={msg.id} className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}>
                                                        <div className={`max-w-[75%] space-y-2`}>
                                                            <div className={`p-6 rounded-[32px] text-sm font-medium leading-relaxed shadow-sm transition-all hover:shadow-md ${msg.sender === 'me'
                                                                ? 'bg-[#1D2939] text-white rounded-tr-none'
                                                                : 'bg-white text-[#1D2939] border border-gray-100 rounded-tl-none'
                                                                }`}>
                                                                {msg.text}
                                                            </div>
                                            ...
                                            <div className="p-10 bg-white border-t border-gray-50">
                                                <div className="flex items-center gap-6 bg-gray-50/80 p-3 pr-3 rounded-[32px] border border-gray-100 focus-within:bg-white focus-within:border-[#D0771E]/30 focus-within:ring-4 focus-within:ring-[#D0771E]/5 transition-all">
                                                    <div className="flex items-center gap-1 pl-2">
                                                        <button className="p-3 text-gray-400 hover:text-[#D0771E] hover:bg-white rounded-2xl transition-all">
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="flex-1 bg-transparent border-none focus:ring-0 text-sm font-medium py-3 px-2 resize-none placeholder:text-gray-400"
                                                    ></textarea>
                                                    <div className="flex items-center gap-2">
                                                        <button className="p-4 bg-[#1D2939] text-white rounded-[24px] shadow-xl shadow-gray-200 hover:bg-[#D0771E] hover:scale-105 active:scale-95 transition-all">
                                        ...
                                        <div className="w-96 flex flex-col h-full bg-[#F3F0EB] items-center py-12 px-10 overflow-y-auto overflow-x-hidden">
                                            <div className="relative mb-8 group">
                                                ...
                                                <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=200&auto=format&fit=crop" alt="Client Large" className="w-32 h-32 rounded-[48px] object-cover ring-8 ring-white/50 shadow-2xl relative z-10 transition-transform duration-700 group-hover:scale-105" />
                                                <div className="absolute -bottom-2 -left-2 w-10 h-10 bg-[#D0771E] rounded-2xl flex items-center justify-center text-white border-4 border-[#F3F0EB] z-20 shadow-lg">
                                                    <MagnifyingGlassIcon className="w-5 h-5" />
                                                </div>
                                            </div>

                                            <div className="text-center mb-10 w-full px-4">
                                                <h4 className="text-xl font-black text-[#1D2939] tracking-tight">Oluwatobiloba Babatunde</h4>
                                                <p className="text-[10px] font-black text-[#D0771E] uppercase tracking-[0.25em] mt-2">Premium Planner • Lagos</p>
                                            </div>

                                            <div className="w-full space-y-6">
                                                <div className="p-8 bg-white/60 backdrop-blur-sm rounded-[32px] border border-white/50 shadow-sm hover:shadow-md transition-shadow">
                                                    <p className="text-[9px] font-black uppercase text-gray-400 tracking-[0.2em] mb-4">Direct Communication</p>
                                                    <div className="space-y-4">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-8 h-8 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400">
                                                                <ArrowPathIcon className="w-4 h-4" />
                                                            </div>
                                                            <p className="text-xs font-black text-[#1D2939]">oluwa.babs@example.com</p>
                                                        </div>
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-8 h-8 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400">
                                                                <PhoneIcon className="w-4 h-4" />
                                                            </div>
                                                            <p className="text-xs font-black text-[#1D2939]">+234 802 345 6789</p>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div className="p-8 bg-gradient-to-br from-[#1D2939] to-[#2D3848] rounded-[32px] text-white shadow-xl relative overflow-hidden group">
                                                ...
                                                <div className="pt-6">
                                                    <Button variant="ghost" className="w-full text-red-500 hover:bg-red-50 text-[10px] font-black uppercase tracking-widest h-12 rounded-2xl">Block Requester</Button>
                                                </div>
                                            </div>
                                        </div>
